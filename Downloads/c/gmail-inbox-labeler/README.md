# Gmail Inbox Labeler (Chrome Extension)

Adds a small, native-feeling label control next to each email subject in Gmail’s inbox. Labels persist locally (no backend, no API calls).
